  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-semibold text-white">Configuração da Análise</h2>
          <p className="text-gray-400 mt-1">Configure os indicadores e métricas para análise</p>
        </div>
        <Button
          onClick={() => {
      ...
      {!selectedEmpresa ? (
        <EmptyState message="Selecione uma empresa para configurar as análises" />
      ) : configs.length === 0 ? (
